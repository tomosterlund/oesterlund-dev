...
The result of my efforts so far is now found here: https://schedule-x.dev/. If you’re not customizing a lot in Qalendar, chances are you could be able to switch to Schedule-X with fairly low effort, if you wish to do so. I would love to see you there. Schedule-X is now the project that I will keep working on and keep enhancing. If you customize a lot of things though, it will probably take a while longer until Schedule-X can offer you everything Qalendar can offer.
